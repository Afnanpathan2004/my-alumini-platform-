    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        <section id="job-assistance" className="dashboard-section">
          ...
          <button className="action-button">Explore Job Assistance</button>
        </section>
        ...
        <section id="fundraising" className="dashboard-section">
          ...
          <button className="action-button">Support Fundraising</button>
        </section>
        ...
        <section id="community-chat" className="dashboard-section">
          ...
          <button className="action-button">Join Community Chat</button>
        </section>
        ...
        <section id="resources" className="dashboard-section">
          ...
          <button className="action-button">Explore Resources</button>
        </section>
        ...
        <section id="university-tips" className="dashboard-section">
          ...
          <button className="action-button">Get University Tips</button>
        </section>
      </main>
